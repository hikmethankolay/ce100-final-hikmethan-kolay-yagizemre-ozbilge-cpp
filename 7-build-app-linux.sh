...
reportgenerator "-title:Rental Management Library Documentation Coverage Report (Linux)" "-reports:**/lcov_doxygen_lib_linux.info" "-targetdir:docs/coverxygenliblinux" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_linux"
...
reportgenerator "-title:Rental Management Library Test Documentation Coverage Report (Linux)" "-reports:**/lcov_doxygen_test_linux.info" "-targetdir:docs/coverxygentestlinux" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_linux"
...
cp -r "$currentDir/original_test_files/"* "$currentDir/build_linux/src/tests/fitness_management_test/"
...
./publish_linux/bin/fitness_management_tests
./publish_linux/bin/fitness_management_app
...
reportgenerator "-title:Rental Management Library Unit Test Coverage Report (Linux)" "-reports:**/coverage_linux.info" "-targetdir:docs/coveragereportliblinux" "-reporttypes:Html" "-sourcedirs:src/fitness_management_lib/src;src/fitness_management_lib/header;src/fitness_management_app/src;src/fitness_management_app/header;src/tests/fitness_management_test" "-filefilters:-*minkernel\*;-*gtest*;-*a_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_linux"

"-sourcedirs:src/fitness_management_lib/src;src/fitness_management_lib/header;src/fitness_management_app/src;src/fitness_management_app/header;src/tests/fitness_management_lib" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_linux"
reportgenerator "-reports:**/coverage_linux.info" "-targetdir:assets/codecoverageliblinux" "-reporttypes:Badges" "-sourcedirs:src/fitness_management_lib/src;src/fitness_management_lib/header;src/fitness_management_app/src;src/fitness_management_app/header;src/tests/fitness_management_test" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
cp -R src/fitness_management_lib/header build_linux/build/Release
...
cp -R src/fitness_management_lib/header build_linux/build/Debug
